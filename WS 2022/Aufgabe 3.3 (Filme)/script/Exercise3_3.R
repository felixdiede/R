# Aufgabe 3.3 (Filme)
setwd("/Users/felixdiederichs/R/WS 2022/Aufgabe 3.3 (Filme)")

# Aufgabe 3.3 a
marvel <- read.csv(file = "data/mcu.csv", header = TRUE, sep = ";")
summary(marvel)
str(marvel)
...
# 1. Filtern Sie den Datensatz nach Filmreihen
filmreihen <- c("Iron Man", "Hulk", "Thor",
                "Captain America", "Avengers", "Guardians of the Galaxy",
                "Ant-Man", "Doctor Strange", "Spider-Man", "Black Panther",
                "Captain Marvel", "Black Widow", "Shang-Chi", "Eternals")
